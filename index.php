...
<body>
	...
	<div class="menu middle" id="home">
		<div class="container">
			...
			<nav>
				...
				<ul class="nav">
					<li class="active">
						<a href="#home" data-easing="easeInOutCubic" data-scroll="" data-speed="900" data-url="false">
							Home
						</a>
					</li>
					<li>
						<a href="#description" data-easing="easeInOutCubic" data-scroll="" data-speed="900" data-url="false">
							Ferienwohnung
						</a>
					</li>
					<li>
						<a href="#gallery" data-easing="easeInOutCubic" data-scroll="" data-speed="900" data-url="false">
							Galerie
						</a>
					</li>
					<li>
			...
			<ul>
				...
				<li data-transition="fade" data-slotamount="7" data-masterspeed="500"  data-saveperformance="off" >
					...
					<div class="tp-caption lfb rs-parallaxlevel-10"
						...
						data-endspeed="500"
						style="z-index: 2;">
							<div class=" rs-pulse"  data-easing="Power4.easeInOut" data-speed="1" data-zoomstart="1" data-zoomend="1.1"><img src="assets/img/slide/dummy.png" alt="" data-lazyload="assets/img/slide/line.png">
							</div>
					</div><!--end tp=caption -->

					<div class="tp-caption bannerSlider2 box customin tp-resizeme rs-parallaxlevel-0"
					data-x="433"
					data-y="555"
					data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;"
					data-speed="150"
	...
	<!-- ================================ -->
	<!-- ================================ -->
	<section class="sectionPadding" id="information" style="padding-bottom:2.5rem;">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
	...
	<!-- ================================ -->
	<section class="sectionPadding sectionProperty sectionBg bgk bgk1" id="description">
		<div class="container">
			<div class="row">
				<div class="col-sm-5">
						...
						<div class="panel-group" id="accordion">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										...
										<a href="#content-1"  data-toggle="collapse" data-parent="#accordion">Innenausstattung Features</a>
									</h4>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<i class="fa fa-check"></i>
										<a href="#content-2" class="collapsed" data-toggle="collapse" data-parent="#accordion">Maße</a>
									</h4>
								</div><!--end panel heading -->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<i class="fa fa-check"></i>
										<a href="#content-3" class="collapsed" data-toggle="collapse" data-parent="#accordion">Service</a>
									</h4>
								</div><!--end panel heading -->
...
Sollten Sie ein Kinderreisebett oder einen Hochstuhl benötigen. Alles kein Problem, fragen Sie uns einfach. Wir stellen es gern zur Verfügung. </p>
	...
	<!-- ================================ -->
	<!-- ================================ -->
	<section class="sectionPadding" id="gallery" style="padding-top:17.5rem; padding-bottom:9.5rem;">
		<div class="container">
	...
	<!-- ================================ -->
	<!-- ================================ -->
	<section class="sectionPadding sectionBg bgk bgk1" id="location">
		<div class="container">
			<div class="row">
...
Ruhig gelegen, aber trotzdem zentral, bietet sie fußläufig das entspannte Strandleben im Sommer und den perfekten Ausgangspunkt für ausgedehnte Spaziergänge oder schöne Wanderungen zur Herbst-  und Winterzeit.</p>
				...
				<!-- ========== MAP ========== -->
				<div class="col-sm-5">
					<div id="map-canvas" class="google-map" data-lat="53.677955" data-long="7.002743" data-img="assets/img/contact/marker.png"></div>
				</div><!--end col-sm-5 -->
			</div><!-- end row-->
		</div><!--end container -->
	</section>
...
Von den Einheimischen nur liebevoll „Töwerland“ genannt, welches im Friesischen soviel wie „Zauberland“ bedeutet, verzaubert sie mit ihrer einmaligen Dünen-Landschaft und dem kilometerlangem feinem Sandstrand. Hier finden Sie Ruhe und Erholung von der Hektik des Alltags und können inmitten einer wunderschönen Naturlandschaft entspannen.
	...
	<!-- ================================ -->
	<!-- ================================ -->
	<section class="sectionPadding" id="contact" style="padding-top:15.5rem; padding-bottom:11.5rem;">
		<div class="container">
			<div class="row">
				<div class="col-sm-12 ">
					<div class="featuresTitle fadeInUp">
...
<!--
							...
							<form action="#" method="post" class="comment-form">
								<ul class="comment-form-inputs">
									<li class="one">
										...
										<input id="authorIndex" name="author" type="text" value="" aria-required="true" required placeholder="Ihr Name...">
									</li>
									<li class="two">
										<img src="assets/img/content/2.png" alt="">
										<input id="emailIndex" name="email" type="text" value="" aria-required="true" required placeholder="Ihre Email...">
									</li>
									<li class="three">
										<img src="assets/img/content/3.png" alt="">
										<input id="url" name="url" type="text" value="" placeholder="Betreff ">
									</li>
								</ul>
								<textarea name="comment" placeholder="Schreiben Sie..." rows="10" required></textarea>
								<p class="form-submitIndex">
									<input name="submit" type="submit" id="submit" value="NACHRICHT SENDEN">
								</p>
							</form>
							</div>
						</div>
	...
	<!-- ================================ -->
	<!-- ================================ -->
	<section style="padding: 3rem 0;" class="bgk bgk2 sectionBg">
		<div class="divimage dzsparallaxer--target position-absolute " style="width: 100%; height: 150%; background-image: url(assets/img/content/footer.jpg)">
        </div>
		<div class="footer">
			<h2>Ferienwohnung <span>Fabian</span></h2>
			<p>
